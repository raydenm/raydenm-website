    ...
    <ScrollArea useScrollAreaId>
      ...
      <div className="content-wrapper">
        <div className="content">
          ...
          <p>我是一名前端开发工程师，对设计和开发富有创造力和用户友好的应用充满热情。</p>
          <p>
            拥有7年的前端开发经验，精通JavaScript，并擅长使用现代框架如React、Vue.js等
            <a className="text-[#3b82f6] underline decoration-1" href="/stack">
              技术栈
            </a>
            。
          ...
          <div className="mb-6">
            在我的个人时间，我喜欢研究新的前端技术和工具，探索设计领域的创新，并撰写博客分享我的学习和心得。如果你有任何问题或者想要交流，请随时与我联系！
            <ContcatContent />
          </div>
